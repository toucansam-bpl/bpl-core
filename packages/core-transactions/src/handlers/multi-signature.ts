...
export class MultiSignatureTransactionHandler extends TransactionHandler {
    ...
    public async bootstrap(connection: Database.IConnection, walletManager: State.IWalletManager): Promise<void> {
        ...
        for (const transaction of transactions) {
            ...
            if (!wallet.hasMultiSignature()) {
                ...
                wallet.setExtraAttribute("multiSignature", multiSignature);
            }
        }
    }
    ...
    protected applyToRecipient(transaction: Interfaces.ITransaction, walletManager: State.IWalletManager): void {
        ...
        if (data.version >= 2) {
            ...
            recipientWallet.setExtraAttribute("multiSignature", transaction.data.asset.multiSignature);
        }
    }
    ...
    protected revertForRecipient(transaction: Interfaces.ITransaction, walletManager: State.IWalletManager): void {
        ...
        if (data.version >= 2) {
            ...
            recipientWallet.unsetExtraAttribute("multiSignature");
        }
    }
}
