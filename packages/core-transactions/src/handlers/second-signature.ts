...
export class SecondSignatureTransactionHandler extends TransactionHandler {
    ...
    public async bootstrap(connection: Database.IConnection, walletManager: State.IWalletManager): Promise<void> {
        ...
        for (const transaction of transactions) {
            ...
            wallet.setExtraAttribute("secondPublicKey", transaction.asset.signature.publicKey);
        }
    }
    ...
    protected applyToSender(transaction: Interfaces.ITransaction, walletManager: State.IWalletManager): void {
        ...
        walletManager
            ...
            .setExtraAttribute("secondPublicKey", transaction.data.asset.signature.publicKey);
    }

    protected revertForSender(transaction: Interfaces.ITransaction, walletManager: State.IWalletManager): void {
        super.revertForSender(transaction, walletManager);

        walletManager.findByPublicKey(transaction.data.senderPublicKey).unsetExtraAttribute("secondPublicKey");
    }
