...
export class IpfsTransactionHandler extends TransactionHandler {
    ...
    public async bootstrap(connection: Database.IConnection, walletManager: State.IWalletManager): Promise<void> {
        ...
        for (const transaction of transactions) {
            ...
            const ipfsHashes: State.IWalletIpfsAttributes = wallet.getExtraAttribute("ipfs.hashes", {});
    ...
    protected applyToSender(transaction: Interfaces.ITransaction, walletManager: State.IWalletManager): void {
        ...
        const ipfsHashes: State.IWalletIpfsAttributes = sender.getExtraAttribute("ipfs.hashes");
